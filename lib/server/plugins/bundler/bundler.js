...
export default fp(
  ...
  async (fastify, { config, hierarchy } = {}) => {
    ...
    fastify.addHook('onListen', async () => {
      ...
      const components = path.join(config.urlBasePath, '/_/components/');
      const layouts = path.join(config.urlBasePath, '/_/layouts/');
      const lit = path.join(config.urlBasePath, '/_/modules/lit');
    ...
    fastify.get(path.join(config.urlBasePath, '/_/lit/hydration.js'), async (request, reply) => {
    ...
    fastify.get(path.join(config.urlBasePath, '/_/components/:component.js'), async (request, reply) => {
    ...
    fastify.get(path.join(config.urlBasePath, '/_/modules/*'), async (request, reply) => {
    ...
    fastify.get(path.join(config.urlBasePath, '/_/layouts/*'), async (request, reply) => {
    ...
    fastify.get(path.join(config.urlBasePath, '/_/pages/:hash.js'), async (request, reply) => {

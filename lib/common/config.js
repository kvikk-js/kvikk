...
export default class Config {
   ...
   */
  get dirSrc() {
    return path.join(this.#cwd, this.#dirSrc);
  }
   ...
   */
  get dirBuild() {
    return path.join(this.dirSrc, this.#dirBuild);
  }
   ...
   */
  get dirComponents() {
    return path.join(this.dirSrc, this.#dirComponents);
  }
   ...
   */
  get dirLayouts() {
    return path.join(this.dirSrc, this.#dirLayouts);
  }
   ...
   */
  get dirPublic() {
    return path.join(this.dirSrc, this.#dirPublic);
  }
   ...
   */
  get dirSystem() {
    return path.join(this.dirSrc, this.#dirSystem);
  }
   ...
   */
  get dirPages() {
    return path.join(this.dirSrc, this.#dirPages);
  }
